...
public class PseudoReplace {
	...
	private static void convertData(final BufferedReader brdr, final PrintStream out, final String pattern, final String replacement) throws IOException {
		int		lineCount = 0;	// <2>
		...
		out.flush();	// <4>
		System.err.println("Conversion ended, "+lineCount+" lines processed, duration="+(System.currentTimeMillis()-start));
	}
